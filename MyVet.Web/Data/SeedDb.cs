...
//            {
//                AddOwner("OOGL960822HDGSLS05", "Luis Gerardo", "Osornio Galván", "7119064", "8714027811", "Gomez Palacio");
...
//        private void AddOwner(string document, string firstName, string lastName, string Phone, string cellPhone, string address)
//        {
...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("OOGL960822HDGSLS05", "Luis Gerardo", "Osornio Galvan", "thewalkingdeadthall22@gmail.com", "8711643268", "Gomez Palacio, Dgo", "Admin");
            var customer = await CheckUserAsync("15141647", "Luis", "Galvan", "twd_dark@hotmail.com", "8713431870", "Torreón Coahuila", "Customer");
            await CheckPetTypesAsync();
            await CheckServiceTypesAsync();
