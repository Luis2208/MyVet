...
namespace MyVet.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel modelo)
        {
            if (ModelState.IsValid)
            {
                ...
                var response = await _userHelper.AddUserAsync(user, modelo.Password);
                if (response.Succeeded)
                {
                    var userInDB = await _userHelper.GetUserByEmailAsync(modelo.Username);
        ...
        public async Task<IActionResult> DeletePet(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "La mascota no puede ser borrada porque contiene registros relacionados");
